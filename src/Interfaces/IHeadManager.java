...
public interface IHeadManager
{
     ...
     */
    public void suspendPlayer(Pitcher player, String reason);
     ...
     */
    public void putPlayerOnInjuredList(Pitcher player);
     ...
     */
    public void offerTrade(ITeam team, Pitcher player, Pitcher req);
