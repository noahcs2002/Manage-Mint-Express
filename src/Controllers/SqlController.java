...
public class SqlController 
{
    ...
    /**
     * If a player has been updated, this function is called to apply that change in SQL.
     * @param data All data from the table.
     * @param team The current team.
     * @param pos The current position selected.
     */
    ...
    /**
     * Called to reset the database. This deletes all data and columns.
     */
